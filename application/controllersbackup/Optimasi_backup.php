<?php 
	...
	return $best_neightbor;
		...
		function do_optimasi(){
			...
			echo "<br><br>Hasil aneling adalah ".$dx[$cpos]." Yaitu masjid ".$masjid['nama_masjid'];
	...
	// 		);
		...
		function optimasi(){
			...
			array_walk($data, function(&$val) use (&$param,&$pmax,&$di){
				...
				$val['di'] = round(($val['v1'] + $val['v2'] + $val['v3'] + $val['v4'] + $val['v5'] + $val['v6'] + $val['v7'] + $val['v8'] + $val['v9'] + $val['v10'] + $val['v11']) / 11,2);
